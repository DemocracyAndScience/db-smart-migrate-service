...
public class TargetConstraint {
	...
	private String changeConstraintName;
	...
	public String getChangeConstraintName() {
		return changeConstraintName;
	}
	public void setChangeConstraintName(String changeConstraintName) {
		this.changeConstraintName = changeConstraintName;
	}
